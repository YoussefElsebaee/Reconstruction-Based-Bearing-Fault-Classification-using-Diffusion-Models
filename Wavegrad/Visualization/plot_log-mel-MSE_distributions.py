...
RESULTS_PATH = Path(
    r"C:\Users\yosef\OneDrive - GIU AS - German International University of Applied Sciences\Desktop\metrics (log_mel_MSE)\10dB noise\classification_results_logmelMSE.xlsx")

LABEL_COL = "true_class"
SAMPLE_COL = "sample"

MODEL_LOSS_COLUMNS = {
    "Normal model": "MSE_normal",
    "Ball model": "MSE_ball",
    "Inner model": "MSE_inner",
    "Outer model": "MSE_outer",
}
...
def plot_class_distributions(df, target_class, save_path=r"C:\Users\yosef\OneDrive - GIU AS - German International University of Applied Sciences\Desktop\metrics (log_mel_MSE)\10dB noise\KDE_distributions"):
    ...
    fig.supxlabel("log-mel MSE", fontsize=12)
